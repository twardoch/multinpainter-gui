...
Welcome to `multinpainter_gui` contributor's guide.
...
If you experience bugs or general issues with `multinpainter_gui`, please have a look
...
You can help improve `multinpainter_gui` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`multinpainter_gui` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `multinpainter_gui`'s files. While this mechanism can
...
```
conda create -n multinpainter_gui python=3 six virtualenv pytest pytest-cov
conda activate multinpainter_gui
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/multinpainter_gui.git
   cd multinpainter_gui
   ```
...
5. Install [pre-commit]:
   ...
   `multinpainter_gui` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/multinpainter_gui
[issue tracker]: https://github.com/<USERNAME>/multinpainter_gui/issues
